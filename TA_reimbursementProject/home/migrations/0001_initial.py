    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.IntegerField(choices=[(0, 'Cancelled'), (-1, 'Pending for admin approval'), (1, 'Request accepted')], default=-1)),
                ('apl', models.OneToOneField(default=None, on_delete=django.db.models.deletion.CASCADE, to='home.application')),
            ],
        ),
        migrations.AddField(
            model_name='application',
            name='profile',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='applications', to='home.user_profile'),
        ),
    ]
